...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Premortem — AI Campaign Pre-Testing Simulator" },
      { name: "description", content: "Don't guess. Simulate. Pre-test marketing campaigns across audience segments before launch." },
      { name: "author", content: "Premortem" },
      { property: "og:title", content: "Premortem — AI Campaign Pre-Testing Simulator" },
      ...
      { name: "twitter:title", content: "Premortem — AI Campaign Pre-Testing Simulator" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&family=Space+Grotesk:wght@500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap",
      },
    ],
  }),
